            ...
            <div className='h-full w-full'>
                    ...
                    <div className="font-[CMUSerifRoman] w-full flex justify-center">
                        <div className="w-[90%]">
                            ...
                            <div className="flex border-b-2 border-black font-bold relative" id='education'>
                            ...
                            <div className="flex border-b-2 border-black font-bold relative" id='experience'>
                                <div className='text-[1.4rem]'>E</div>
                            ...
                            <div className="flex border-b-2 border-black font-bold relative" id='projects'>
                            ...
                            <div className="flex border-b-2 border-black font-bold relative" id='tech-skills'>
